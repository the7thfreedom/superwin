...
- 50+ shipped default shortcuts (`src/renderer/hotkeys/registry.ts`).
...
│                                                         │
│  src/main/lib/keyboardLayout.ts            │
│   └─ EventEmitter wrapping native-keymap, lazy-init     │
│                                                         │
│  src/lib/trpc/routers/keyboardLayout.ts    │
...
```
src/main/lib/keyboardLayout.ts                   # native-keymap wrapper
src/lib/trpc/routers/keyboardLayout.ts           # tRPC bridge
src/renderer/hotkeys/
...
src/main/lib/menu.ts                             # ⚠ hardcoded; see "Known gaps"
src/renderer/lib/terminal/                       # terminal forwarding integration
```
